...
Follow these steps:
1. Compile: 
	gfortran iterativeAckermannFunction.f90 -o iterativeAckermannFunction
2. RUN: 
	./iterativeAckermannFunction

'Ackermann function iterative in Fortran: Enter two numbers (Below 4 for a quick result)'
