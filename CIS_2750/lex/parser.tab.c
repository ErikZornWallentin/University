...
{
  "$end", "error", "$undefined", "TITLE", "FIELDS", "BUTTONS", "EQUALS",
  "STRING", "WORD", "SEMICOLON", "QUOTES", "OPENBRACKET", "CLOSEBRACKET",
  "COMMA", "COMMENT", "SET", "STATE", "MODE", "GET", "EOLN", "$accept",
  "list", "getorset", "setvalue", "getvalue", YY_NULLPTR
};
#endif
...
#line 17 "parser.y" /* yacc.c:1646  */
    { strcpy(state,(yyvsp[0])); printf("State set\n"); }
